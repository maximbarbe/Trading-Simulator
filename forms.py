...
class userForm(FlaskForm):
    ...
    confirm_email = EmailField(label="Email", validators=[DataRequired(), Length(1, 100, f"Email {character_message}"), EqualTo("email", "Must be equal to the email field.")], description="Confirm email")
