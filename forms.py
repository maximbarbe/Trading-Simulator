...
class registerForm(FlaskForm):
    ...
    email = StringField(label="Email", validators=None, description="Email")
    confirm_email = StringField(label="confirm_email", validators=None, description="Confirm email")
